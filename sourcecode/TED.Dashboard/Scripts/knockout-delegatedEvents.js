...
; (function (factory) {
    ...
    var createDelegatedHandler = function (eventName, root, bubble) {
        return function (event) {
            var data, index, method, context, action, owner, matchingParent, command, result, parent, parentIndex,
            ...
            if (method) {
                ...
                var parentContext = ko.contextFor(el.parentElement);
                ...
                if (action) {
                    ...
                    if (eventName === "submit") {
                        result = action.call(data, event.target, index, parent, parentIndex);
                    } else {
                        result = action.call(owner, data, event, index, parent, parentIndex);
                    }
    ...
    var createDelegatedBinding = function (event) {
        ...
        //get binding name
        var bindingName = createBindingName(event);
