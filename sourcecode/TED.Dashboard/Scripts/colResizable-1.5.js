...
(function($){ 	
	...
	var init = function( tb, options){	
	    ...
	    if (t.opt.refresh) refresh(t);                      // the user wants to refresh the column sizes
    ...
    /**
     *  This function refreshes with widths for the grips and columns
     */
    var refresh = function(t) {
        ...
        // reset the widths on the columns headers
        th.each(function() {
            var c = $(this);
            c.css("width", c.width());
        });
